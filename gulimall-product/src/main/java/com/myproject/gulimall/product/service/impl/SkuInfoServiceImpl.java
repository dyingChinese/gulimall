...
import com.myproject.gulimall.product.dao.SkuInfoDao;
...
import com.myproject.gulimall.product.vo.SeckillSkuVo;
    ...
    public SkuItemVo item(Long skuId) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Void> seckillFuture = CompletableFuture.runAsync(() -> {
            ...
            if (skuSeckilInfo.getCode() == 0) {
                //查询成功
                SeckillSkuVo seckilInfoData = skuSeckilInfo.getData("data", new TypeReference<>() {
                });
